<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="Product" v-model="item.product" :editMode="editMode" @change="change" />
            </div>
            <order_status offline label="OrderStatus" v-model="item.orderStatus" :editMode="false" :key="false" @change="change" />
        </v-card-text>
