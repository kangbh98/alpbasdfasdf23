<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="Nickname" v-model="item.nickname" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="ProfileImg" v-model="item.profileImg" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="RefreshToken" v-model="item.refreshToken" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="Credit" v-model="item.credit" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
