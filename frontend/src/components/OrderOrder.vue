<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <Number label="Product" v-model="value.product" :editMode="editMode" :inputUI="''"/>
            <order_status offline label="OrderStatus" v-model="value.orderStatus" :editMode="editMode" @change="change"/>
        </v-card-text>
